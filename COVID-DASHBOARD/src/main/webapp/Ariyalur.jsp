...
<body>
<h1 align="center"><b>ARIYALUR REPORT</b></h1><br><br>
<div class="highcharts-figure">  <!-- instead of div we can also use figure -->
...
<!-- AddToAny END -->
<a href="http://localhost:8065/COVID-DASHBOARD/Ariyalur.jsp" role="button" class="btn btn-primary float-right" id="download" download="districtreport">DOWNLOAD</a>
<% 
