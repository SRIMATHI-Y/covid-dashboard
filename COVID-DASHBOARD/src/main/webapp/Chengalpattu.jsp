...
<body>
<h1 align="center"><b>CHENGALPATTU REPORT</b></h1><br><br>
...
<!-- AddToAny END -->
<a href="http://localhost:8065/COVID-DASHBOARD/Chengalpattu.jsp" role="button" class="btn btn-primary float-right" id="download" download="districtreport">DOWNLOAD</a>
<% 
