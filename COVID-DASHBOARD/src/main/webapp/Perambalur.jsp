...
<body>
<h1 align="center"><b>PERAMBALUR REPORT</b></h1><br><br>
...
<!-- AddToAny END -->
<a href="http://localhost:8065/COVID-DASHBOARD/Perambalur.jsp" role="button" class="btn btn-primary float-right" id="download" download="districtreport">DOWNLOAD</a>
<% 
