...
<body>
<h1 align="center"><b>VIRUDHUNAGAR REPORT</b></h1><br><br>
...
<!-- AddToAny END -->
<a href="http://localhost:8065/COVID-DASHBOARD/Virudhunagar.jsp" role="button" class="btn btn-primary float-right" id="download" download="districtreport">DOWNLOAD</a>
<!-- <a class="btn btn-primary float-center" role="button" id="export">EXPORT</a> -->
